...
public class Forecast_day {
    ...
    Integer  day	;//		Jour entre 0 et 13 (Pour le jour même : 0, pour le lendemain : 1, etc.)
    ...
    float  rr10	;//		Cumul de pluie sur la journée en mm
    float	rr1	 ;//	Cumul de pluie maximal sur la journée en mm
    Integer	probarain	 ;//	Probabilité de pluie entre 0 et 100%
    Integer  weather;//		Temps sensible (Code temps) – Voir Annexes
    Integer tmin	;//		Température minimale à 2 mètres en °C
    Integer   tmax	;//		Température maximale à 2 mètres en °C
    Integer sunHours	;//	Ensoleillement en heures
    float	 etp	;// Cumul 	d'évapotranspiration en mm
